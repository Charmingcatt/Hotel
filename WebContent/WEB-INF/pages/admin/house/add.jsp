...
<html lang="en">
   ...
   <div class="box round first" style="margin:15px;">
                ...
                <div class="block">
<form style="width:50%" method="POST" action="<%=basePath%>house/house/save" enctype="multipart/form-data">
                    ...
                    <table class="form">
                        ...
                        <tr>
                            ...
                            <td class="col3">
                                ...
                                <input name="price2" required value="" type="text" class="medium" id="grumble">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                ...
                                <input name="thunb" required value="" type="text" id="thumb">
