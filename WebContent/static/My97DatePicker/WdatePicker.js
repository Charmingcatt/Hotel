...
var m = getReal(day.getMonth()+1);
var d = getReal(day.getDate());
var h = getReal(day.getHours());
var i = getReal(day.getMinutes()+1);
var s = getReal( day.getSeconds());
var str = y+"-"+m+"-"+(d+1)+" "+h+":"+i+":"+s;
//str = '1970-01-01';
console.log(str);
